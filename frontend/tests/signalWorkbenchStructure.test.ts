...
assertIncludes(workbenchSource, "setSelectedSearchIntentLabel(null);");
assertIncludes(workbenchSource, "filterSignalsBySearchIntent(displayProductScopedSignals, intentLabel)");
assertIncludes(workbenchSource, "filterSignalsBySearchIntent(displayProductScopedSignals, selectedSearchIntentLabel)");
...
assertIncludes(workbenchSource, "搜索词机会二级筛选");
assertIncludes(workbenchSource, "只缩小当前诊断入口内的 SearchTerm 机会队列");
...
assertIncludes(workbenchSource, "搜索词语义筛选不切换经营商品或广告组");
assertIncludes(workbenchSource, "当前搜索词语义筛选暂无对应机会");
assertIncludes(workbenchSource, 'aria-label="搜索词机会二级筛选"');
...
const searchIntentReviewPanelIndex = workbenchSource.indexOf('aria-label="搜索词机会二级筛选"');
...
assert(searchIntentReviewPanelIndex > queueTabsIndex, "搜索词机会二级筛选必须跟在队列筛选之后");
assert(searchIntentReviewPanelIndex < signalRowsIndex, "搜索词机会二级筛选必须贴近信号队列，而不是作为独立主入口");
