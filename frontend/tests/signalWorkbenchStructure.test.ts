...
assert(searchIntentFocusContextRenderIndex > selectedSignalScopeContextRenderIndex, "广告搜索词表现承接必须跟在入口关系之后");
assert(searchIntentFocusContextRenderIndex < signalDiagnosisRenderIndex, "广告搜索词表现承接必须先于信号详情展示");
