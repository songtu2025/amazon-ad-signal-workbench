...
assert(adGroupEvidenceSwitcherIndex < adGroupChecklistIndex, "证据切换器必须先于运营检查清单，避免默认展开四层明细");
assert(adGroupDataSummaryIndex < focusMetricsIndex, "广告组下具体数据摘要必须先于广告组证据摘要");
assert(adGroupDataSummaryIndex < adGroupChecklistIndex, "广告组下具体数据摘要必须先于运营检查清单");
...
assertIncludes(reviewUiSource, "缺少搜索词、Parent ASIN 广告搜索词表现复核或搜索词表现判断");
...
assertIncludes(reviewUiSource, "从哪个 Parent ASIN / 广告对象展开");
