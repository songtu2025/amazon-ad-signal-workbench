...
assertIncludes(workbenchSource, 'return "Parent ASIN 搜索词表现聚合";');
...
assertIncludes(signalUiSource, "来自当前 Parent ASIN 关联广告中实际产生表现的用户搜索词行");
assertIncludes(signalUiSource, "Parent ASIN 搜索词表现聚合「${focusLabel}」只是分析分组");
assertIncludes(workbenchSource, "Parent ASIN 视角聚合");
assertIncludes(workbenchSource, "聚合标签");
...
assertIncludes(workbenchSource, 'aria-label="Parent ASIN 搜索词表现聚合核对"');
