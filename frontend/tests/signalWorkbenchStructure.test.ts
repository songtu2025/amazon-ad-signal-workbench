...
assertIncludes(workbenchSource, "manualActionDisplayLabel(recommendedManualActionCandidate.manualActionPreview.actionType)");
assertIncludes(workbenchSource, "manualActionDisplayLabel(nextUnhandledManualActionCandidate.manualActionPreview.actionType)");
