...
assertIncludes(workbenchSource, "Parent ASIN 广告搜索词聚合复核");
assertIncludes(workbenchSource, "从当前 Parent ASIN 视角聚合广告中的用户搜索词表现");
assertIncludes(workbenchSource, 'aria-label="广告搜索词聚合复核数据口径"');
...
assertIncludes(workbenchSource, 'aria-label="广告搜索词聚合复核空态"');
...
assertIncludes(workbenchSource, "广告搜索词聚合复核不切换经营商品或广告组");
assertIncludes(workbenchSource, "当前 Parent ASIN 广告搜索词聚合复核暂无对应 AI 信号");
assertIncludes(workbenchSource, 'aria-label="Parent ASIN 广告搜索词聚合复核"');
